...
import { insertPrayerCommentSchema, type InsertPrayerComment } from "@shared/schema";
...
export function PrayerCommentForm({ prayerId }: { prayerId: string }) {
  ...
  const createCommentMutation = useMutation({
    mutationFn: async (data: InsertPrayerComment) => {
      return await apiRequest("POST", `/api/prayers/${prayerId}/comments`, data);
    },
    onSuccess: () => {
  ...
  const onSubmit = (data: InsertPrayerComment) => {
